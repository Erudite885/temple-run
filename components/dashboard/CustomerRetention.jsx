...
const CustomerRetention = ({ ...rest }) => {
  return (
    <StatsCard title="Customer Retention" titleSize="2xl" {...rest}>
      <Center textAlign="center">Target &gt;= 90%</Center>
      ...
      <Center mt={7} as={Heading}>
        92%
      </Center>

      <ResponsiveContainer width={400} maxHeight={280}>
        <BarChart
          width={500}
          height={600}
          data={data}
