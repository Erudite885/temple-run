  ...
  return (
    ...
    >
      <HStack w="100%" justifyContent="space-evenly" p={4}>
        ...
        <Select w="25%">
          <option>Travel360</option>
          <option>House of Travel</option>
          <option>Flight World</option>
          <option>Auckland Tours and Travel</option>
          <option>Sky Tower Tours</option>
          <option>Escape</option>
          <option>WishTrip</option>
